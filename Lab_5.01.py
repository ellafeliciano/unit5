...
'idk': 'a phrase meaning i dont know',
'tbd': 'a phrase meaning to be decided',
'nbd': 'a phrase meaning no bid deal',
'ily': 'a phrase meaning i love you',
'imy': 'a phrase meaning i miss you',
'asap': 'a phrase meaning as soon as possible',
'omw': 'a phrase maning on my way'  
}

game_over = False

while game_over == False:
    user_choice = input("What word would you like to look up? ")
    if user_choice in my_dictionary:
        print(my_dictionary[user_choice])
    elif user_choice == 'quit':
        game_over = True
    else:
        print(f"Sorry, {user_choice} is not defined.")

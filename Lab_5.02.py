...
while 0 == 0:
    ...
    if user_choice in word_frequency:
        print("There are " + str(word_frequency[user_choice]) + ' of '+  user_choice + ' in this paragraph.')
    else:
        print('Sorry, ' + user_choice + ' is not in this paragraph! Please try again.')